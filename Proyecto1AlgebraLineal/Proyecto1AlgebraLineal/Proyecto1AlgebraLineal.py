...
class AppPrincipal:
    ...
    def mostrar_grafica(self):
        ...
        # Colores obligatorios de la rubrica [cite: 12]
        plt.axhline(0, color='gray', linewidth=1) # Ejes Grises [cite: 12]
        plt.axvline(0, color='gray', linewidth=1)
        
        t = np.linspace(-15, 15, 100)
        plt.plot(p[0]+t*d[0], p[1]+t*d[1], color='green', label='Linea (Verde)', linewidth=2) # Linea Verde [cite: 12]
